...
Namespace HowToShowFilteredListViewFromNavigationControl.Win
	Partial Public Class HowToShowFilteredListViewWindowsFormsApplication
		...
		Private Sub HowToShowFilteredListViewFromNavigationControlWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
